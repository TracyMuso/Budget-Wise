  ...
  def create
    ...
    respond_to do |format|
      if @group_category.save
        format.html do
          redirect_to group_category_url(@group_category), notice: 'Group category was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @group_category.update(group_category_params)
        format.html do
          redirect_to group_category_url(@group_category), notice: 'Group category was successfully updated.'
        end
